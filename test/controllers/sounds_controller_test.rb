...
class SoundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post sounds_url, params: { sound: { description: @sound.description, key: @sound.key, name: @sound.name, tempo: @sound.tempo, type: @sound.type } }
    end
  ...
  test "should update sound" do
    patch sound_url(@sound), params: { sound: { description: @sound.description, key: @sound.key, name: @sound.name, tempo: @sound.tempo, type: @sound.type } }
